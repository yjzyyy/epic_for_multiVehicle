...
template <typename PointType>
void KD_TREE<PointType>::setMap_ikdtree(fast_planner::SDFMap* sdf){
    this->sdf_ = sdf;
}

template <typename PointType>
void KD_TREE<PointType>::setMap_ikdtree(fast_planner::LIOInterface* lidar_map){
...
// template <typename PointType>
// void KD_TREE<PointType>::Radius_Delete(PointType point, const float radius, PointVector &Storage)
// {
//     Storage.clear();
//     Search_by_radius_and_delete(Root_Node, point, radius, Storage);
// }

// template <typename PointType>
// void KD_TREE<PointType>::Radius_Delete_Frt(PointType point, const float radius, PointVector &Storage, unordered_map<int, Eigen::Vector3f> &frt_norm, Eigen::Vector3f &map_min_bd_, double &inv_cell_size_)
// {
//     Storage.clear();
//     Search_by_radius_and_delete_frt(Root_Node, point, radius, Storage, frt_norm, map_min_bd_, inv_cell_size_);
// }
